...
next_state(weapons,a,weapons):-
    stored_answer(have_weapon,no).

next_state(weapons,b,village):-
    stored_answer(have_weapon,yes).

next_state(weapons,b,weapons):-
    stored_answer(have_weapon,no).

next_state(weapons,c,village):-
    stored_answer(have_weapon,yes).

next_state(weapons,c,weapons):-
    stored_answer(have_weapon,no).

next_state(armor,a,village):-
    stored_answer(have_armor,yes).

next_state(armor,a,armor):-
    stored_answer(have_armor,no).

next_state(armor,b,village):-
    stored_answer(have_armor,yes).

next_state(armor,b,armor):-
    stored_answer(have_armor,no).

next_state(armor,c,village):-
    stored_answer(have_armor,yes).

next_state(armor,c,armor):-
    stored_answer(have_armor,no).

next_state(armor,d,village):-
    stored_answer(have_armor,yes).

next_state(armor,d,armor):-
    stored_answer(have_armor,no).
...
show_state(battle1):-
    ...
    write('(c) Aim for thier leg'),nl,
    write('(d) Aim for thier arm'),nl,
    write('(q) Quit the adventure'),nl.
